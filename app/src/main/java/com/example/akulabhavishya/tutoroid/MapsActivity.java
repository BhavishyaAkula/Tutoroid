...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location2 = getIntent().getStringExtra("MapLocation");
...
//        }
        ...
        Toast.makeText(getApplicationContext(),"Distance between places: "+Math.round((dis/1000)*100.0f)/100.0,Toast.LENGTH_SHORT).show();
