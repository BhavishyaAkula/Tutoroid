...
import static com.example.akulabhavishya.tutoroid.TutorDetailsActivity.hasPermissions;

public class Belogin extends AppCompatActivity {
    EditText e1,e2;
    Button b1;
    TextView t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_belogin);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(),Bereg.class);
    ...
    private void supload() {
        ...
        String serverurl = API.addtutorloginurl ;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (res.equals("success"))
                    {
                        ...
                        e1.setText(null);
                        e2.setText(null);
                        Intent intent=new Intent(getApplicationContext(),Behome.class);
                        startActivity(intent);
